      ...
      <div className="flex gap-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="pl-6 flex flex-col gap-1">
            <li className="text-muted-foreground font-medium">Date: 09/05/2024</li>
            <li className="text-muted-foreground font-medium">Time: 10:25 pm</li>
            <li className="text-muted-foreground font-medium">Systems: pc1,pc2,pc3</li>
          </ul>
          </div>
          <div>
            <TotalPieChart/>
        ...
        <div className="bg-accent rounded-lg h-max p-5 shadow-md flex-grow">
          ...
          <div className="text-9xl text-primary text-center font-semibold">69</div>
        </div>
