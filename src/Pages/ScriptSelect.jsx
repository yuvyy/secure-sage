...
const ScanInfoPage = () => {
  ...
  // Initialize checkList with selectedItems as the first array
  const [checkList, setCheckList] = useState([selectedItems, []]);
  ...
  useEffect(() => {
    // Update checkList with selectedChecks and category name
    setCheckList((prevCheckList) => {
      const updatedChecksArray = data.map((category) => ({
        categoryName: category.category,
        checks: selectedChecks[category.category] || [],
      }));

      return [prevCheckList[0], updatedChecksArray];
    });
  }, [selectedChecks]);
